...
let domain = "lunarmail.io";
let fullUrl = "https://lunarmail.io";
...
const execute = async (url, inputText)=>{
...
const details = {
    name: "crawl domain and generate tokens and emebddings",
